...
(
    id INT(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
    sportsName VARCHAR(255),
    leaguesName VARCHAR(255),
    eventsDate DATETIME NOT NULL,
    firstSidesName VARCHAR(255),
    secondSidesName VARCHAR(255),
    active TINYINT(1)
);
...
INSERT INTO cash_accounts VALUES (33,0);
INSERT INTO bookmakers VALUES (1,'Алексей','Пак','1234567','qwe@mail.ru',33);