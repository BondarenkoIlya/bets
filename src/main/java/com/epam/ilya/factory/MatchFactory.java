...
public class MatchFactory {
    public Match createMatch(String sportName, String date, String nameOfSide1, double coefficient1, String nameOfSide2, double coefficient2, double coefficient3) {
