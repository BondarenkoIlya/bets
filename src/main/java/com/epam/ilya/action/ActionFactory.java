...
public class ActionFactory {
    ...
    public ActionFactory() {
        ...
        actions.put("GET/bookmaker-home", new ShowPageAction("bookmaker-home"));
        actions.put("POST/do/login", new LoginAction());
        actions.put("POST/do/register", new RegisterAction());
    }
